...
Page({
  ...
  createOrder: function (e) {
    ...
    wx.request({
      url: 'http://127.0.0.1:8069/' + app.globalData.subDomain + '/order/create',
      method: 'POST',
      header: {
  ...
  initShippingAddress: function () {
    var that = this;
    wx.request({
      url: 'http://127.0.0.1:8069/' + app.globalData.subDomain + '/user/shipping-address/default',
      data: {
  ...
  getMyCoupons: function () {
    var that = this;
    wx.request({
      url: 'http://127.0.0.1:8069/' + app.globalData.subDomain + '/discounts/my',
      data: {
        token: wx.getStorageSync('token'),
        status: 0
      },
