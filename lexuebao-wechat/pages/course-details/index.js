...
Page({
  ...
  onLoad: function (e) {
    ...
    wx.request({
      url: 'http://127.0.0.1:8069/' + app.globalData.subDomain + '/shop/courses/detail',
      data: {
        id: e.id
      },
      header: {
  ...
  labelItemTap: function (e) {
    ...
    */
    ...
    if (canSubmit) {
      wx.request({
        url: 'http://127.0.0.1/' + app.globalData.subDomain + '/shop/goods/price',
        data: {
  ...
  */
  ...
  onShareAppMessage: function () {
    return {
      ...
      path: '/pages/course-details/index?id=' + this.data.goodsDetail.basicInfo.id + '&inviter_id=' + wx.getStorageSync('uid'),
      success: function (res) {
        // 转发成功
      },
      fail: function (res) {
  ...
  reputation: function (goodsId) {
    var that = this;
    wx.request({
      url: 'http://127.0.0.1:8069/' + app.globalData.subDomain + '/shop/goods/reputation',
      data: {
        goodsId: goodsId
      },
      header: {
  ...
  getVideoSrc: function (videoId) {
    var that = this;
    wx.request({
      url: 'http://127.0.0.1:8069/' + app.globalData.subDomain + '/media/video/detail',
      data: {
        videoId: videoId
      },
      header: {
  ...
  goKanjia: function () {
    ...
    wx.request({
      url: 'http://127.0.0.1:8069/' + app.globalData.subDomain + '/shop/goods/kanjia/join',
      data: {
